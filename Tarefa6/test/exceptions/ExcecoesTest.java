 ...
 * 
 * <p>Esta classe verifica que as exceções específicas do domínio
 * do RPG são lançadas corretamente e contêm mensagens adequadas
 * para ajudar na depuração e no tratamento de erros.</p>
 */
public class ExcecoesTest {
     ...
     * 
     * <p>Verifica que a exceção pode ser lançada e capturada
    ...
    public void testNivelInsuficienteException_Lancamento() {
        ...
        assertEquals(mensagemEsperada, exception.getMessage(),
                    "Mensagem da exceção lançada deve ser a esperada");
    }
     ...
     * 
     * <p>Verifica que a exceção é lançada corretamente em
